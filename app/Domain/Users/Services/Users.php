...
class Users extends BaseService
{
    ...
    /**
     * createUserInvite - generates a new invite token and creates the user in the db TODO: Should accept userModel
     *
     ...
     * reconciliation.
     *
     * Returns the new user ID or a status code the controller maps to a notification:
     *   - 'enter_email'    email was empty
     *   - 'no_valid_email' email is not a valid address
     ...
     * @return int|string New user ID or validation status code described above.
     *
     * @throws BindingResolutionException
     *
     * @api
     */
    #[RequiresPermission(UsersPermissions::CREATE, global: true)]
    public function inviteNewUser(array $post, int|string|null $sessionClientId, bool $isManager): int|string
    {
        $values = [
