    ...
    <form id="resetPassword" action="" method="post">
        ...
        <div class="row-fluid">
            <div class="form-group">
                <label for="themeSelect">{{ __('onboarding.theme_visual_style') }}</label>
            ...
            <br />
            <div class="form-group">
                <label>{{ __('onboarding.theme_readability') }}</label>
                <div class="tw-flex">
        ...
        <div class="tw-text-right">
            <a href="{{BASE_URL}}/auth/userInvite/{{$inviteId}}" class="btn btn-secondary" style="width:auto; margin-right:10px">{{ __('buttons.back') }}</a>
